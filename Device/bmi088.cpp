...
static int BMI088_Gyro_Init(void)
{
    uint8_t res = 0;
...
static void BMI088_Offset_Update(BMI088_Info_Typedef *BMI088_Info)
{
  ...
  BMI088_Info->Offsets_Gyro_X =  -0.00177223433f;
  BMI088_Info->Offsets_Gyro_Y =  0.00306582823f;
  BMI088_Info->Offsets_Gyro_Z =  -0.00113681064f;
#endif
...
void BMI088_Init(void)
{
  ...
  /* Initializes the BMI088 */
	...
	do{	
    status = (BMI088_Status_e)((int)status | (int)BMI088_Accel_Init());
		
    status = (BMI088_Status_e)((int)status | (int)BMI088_Gyro_Init());
