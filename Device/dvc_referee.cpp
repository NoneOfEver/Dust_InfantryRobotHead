...
void Referee::Init(UART_HandleTypeDef *huart, uint8_t __Frame_Header)
{
    ...
    {
        uart_manage_object_ = &UART1_Manage_Object;
    }
    else if (huart->Instance == USART2)
    {
        uart_manage_object_ = &UART2_Manage_Object;
    }
    else if (huart->Instance == USART3)
    {
        uart_manage_object_ = &UART3_Manage_Object;
    }
    else if (huart->Instance == UART4)
    {
        uart_manage_object_ = &UART4_Manage_Object;
    }
    else if (huart->Instance == UART5)
    {
        uart_manage_object_ = &UART5_Manage_Object;
    }
    else if (huart->Instance == USART6)
    {
        uart_manage_object_ = &UART6_Manage_Object;
    }
    else if (huart->Instance == UART7)
    {
        uart_manage_object_ = &UART7_Manage_Object;
    }
    else if (huart->Instance == UART8)
    {
        uart_manage_object_ = &UART8_Manage_Object;
    }
