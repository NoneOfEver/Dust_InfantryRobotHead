...
void Fuzzy_Rule_Implementation(FuzzyRule_t *fuzzyRule, float measure, float ref)
{
    ...
    fuzzyRule->dt = dwt_get_delta_t(&fuzzyRule->DWT_CNT);
...
float PID_Calculate(PID_t *pid, float measure, float ref)
{
    ...
    pid->dt = dwt_get_delta_t(&pid->DWT_CNT);
...
{
    ffc->dt = dwt_get_delta_t(&ffc->DWT_CNT);
...
{
    ldob->dt = dwt_get_delta_t(&ldob->DWT_CNT);
...
float TD_Calculate(TD_t *td, float input)
{
    ...
    td->dt = dwt_get_delta_t(&td->DWT_CNT);
